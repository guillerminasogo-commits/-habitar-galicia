...
const content = {
    ...
    works: [
      {
        ...
        img: '/estampa-galega-santiago-compostela-guillermina-sogo.jpg',
      ...
      },
      {
        ...
        place: 'Poio · Galicia',
        img: '/mariscadoras-poio-galicia-guillermina-sogo.jpg',
      ...
      },
      {
        ...
        img: '/viticultores-heroicos-ribeira-sacra-guillermina-sogo.jpg',
  ...
  en: {
    ...
    workLabel: 'Work',
    works: [
      { title: 'ESTAMPA GALEGA', place: 'Santiago de Compostela · Galicia', img: '/estampa-galega-santiago-compostela-guillermina-sogo.jpg', text: 'Between stone and rain, Santiago becomes a scene suspended in time. The barely suggested figure crosses a city that seems to exist outside the present. The photograph does not seek to document a specific instant, but the enduring feeling of a wet, silent and timeless Galicia.', note: 'Series: Retazos de Galicia. Published in OneStop Arts and Practical Photography.' },
      { title: 'AS MARISCADORAS', place: 'Poio · Galicia', img: '/mariscadoras-poio-galicia-guillermina-sogo.jpg', text: 'At the edge between land and sea, the shellfish gatherers repeat a trade passed down through generations. Seen from behind, removed from individuality, the figures become a symbol of collective memory tied to effort, resistance and an intimate relationship with the territory.', note: 'Series: Retazos de Galicia. First Prize in the Photography Competition of the Festa da Ameixa 2018.' },
      { title: 'VITICULTORES HEROICOS', place: 'Ribeira Sacra · Galicia', img: '/viticultores-heroicos-ribeira-sacra-guillermina-sogo.jpg', text: 'On the impossible slopes of the Ribeira Sacra, the landscape also becomes effort. The distant, faceless figures merge with the territory until they almost disappear into it. More than portraying a harvest, the image speaks of human resistance before the landscape.', note: 'Series: Retazos de Galicia.' }
    ],
...
function App() {
  ...
  return (
    <main className="site">
      ...
      <section className="hero" style={{ backgroundImage: "url('/estampa-galega-santiago-compostela-guillermina-sogo.jpg')" }}>
